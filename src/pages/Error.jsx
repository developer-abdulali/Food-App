...
const Error = () => {
  return (
    <div className="w-full lg:p-10 p-4">
      <div className="w-full h-full flex flex-col items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
        <div className="w-full lg:w-3/12 lg:h-full flex lg:items-end justify-center p-4">
          <svg
          ...
          >
            ...
            <circle cx="212.59226" cy="103" r="64" fill="#FFCA86"></circle>
            <path
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
          ...
          <p className="text-2xl md:text-5xl lg:text-6xl font-bold tracking-wider text-gray-300 mt-2">
            Page Not Found
          </p>
          <p className="text-lg md:text-xl lg:text-2xl text-gray-500 my-12">
            {/* Sorry, the page you are looking for could not be found. */}
            Sorry, the data you are looking for is not currently available.
          </p>
          <a
            href="/"
            className="flex items-center space-x-2 bg-[#3f3d56] hover:bg-blue-700 text-white px-4 py-2 rounded transition duration-150"
            title="Return Home"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
